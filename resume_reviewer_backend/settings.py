"""
Django settings for resume_reviewer_backend project.
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'https://resume-reviewer-frontend.vercel.app'
]
...
ROOT_URLCONF = 'resume_reviewer_backend.urls'
...
WSGI_APPLICATION = 'resume_reviewer_backend.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=os.getenv("DATABASE_SSL") == "true"
    )
}
